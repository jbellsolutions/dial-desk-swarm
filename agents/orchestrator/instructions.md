...
- Strategic direction, KPIs, budgets, approvals, delegation
- CEO can then commission production work from any specialist

## Marketing & Campaigns → CMO
- Campaigns, ads, landing pages, copy, lead programs, brand positioning

## Technology & Infrastructure → CTO
- API integrations, deployments, tech stack, system reliability, cost optimization

## Operations & Delivery → COO
- Client onboarding, vendor management, delivery tracking, SOPs, compliance
